...
export const EventDashboard = () => {
    ...
    // Auto-complete event when all scoring is done
    useEffect(() => {
        if (currentEvent && allScored && currentEvent.status === 'ongoing' && teams.length > 0 && juries.length > 0) {
            console.log(`Event ${currentEvent.name} is fully scored, marking as completed...`);
            ...
            <div className="container page-content">
                <div className="flex justify-between items-center mb-xl">
                    <div>
                        ...
                        <p className="text-muted">{new Date(currentEvent.date).toLocaleDateString('fr-FR')}</p>
                    </div>
                ...
                <div className="admin-sections">
                    ...
                    <a href={`/results/${currentEventId}`} target="_blank" rel="noopener noreferrer" className="admin-section-card card">
                        <div className="section-header">
